...
package com.shang.moduleswitch.view;
...
import com.shang.moduleswitch.R;
import com.shang.moduleswitch.utils.AnimationEffects;
import com.shang.moduleswitch.utils.Gusterpolator;
import com.shang.moduleswitch.utils.TouchCircleDrawable;

import java.util.ArrayList;
import java.util.LinkedList;

/**
 * ModeListView 根据状态来抽象
 */
...
//            }
     ...
     */
    public void init(ArrayList<Integer> modeIndexList) {
        mSupportedModes = modeIndexList;
    ...
    private void initializeModeSelectorItems() {
        ...
        for (int i = 0; i < mTotalModes; i++) {
            ...
            // Set image
            selectorItem.setImageResource(R.drawable.ic_switch_camera);

            // Set text
            selectorItem.setText("啦啦啦");
    ...
    private void updateModeListLayout() {
        ...
        mListView.setTranslationY(getHeight()/2
